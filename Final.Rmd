...
# p.s. I met a trouble here, when I open my file in my R project, I can get the right result in chunk, but when I knit this file, html cannot encode right and I will get all NAs. I tried change my R project's encoding option, but it still didn't work. What can I do?

# There seems to be something wrong with the euro dollar symbol
```
